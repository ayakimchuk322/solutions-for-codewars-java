...
public class Pentanacci4 {
    ...
    public static long countOddPentaFib(long n) {
    	...
    	List<BigInteger> pentafib = new LinkedList<BigInteger>();
    	...
    	default:
	    	try {
	    		...
	    		pentafib.add(temp);
				try {
					if ((pentafib.get(pentafib.size() - 1).remainder(BigInteger.valueOf(2))) != BigInteger.ZERO){
						count++;
					}
				} finally{
